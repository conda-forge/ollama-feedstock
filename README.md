...
It is possible to list all of the versions of `ollama` available on your platform:
...
```
pixi search ollama --channel conda-forge
```
...
* [@JakeLehle](https://github.com/JakeLehle/)
